    ...
    class Request
    {
        ...
        public static JObject RPC(string Host, int Port, string Method, JObject Params = null, string Password = null)
        {
            ...
            try
            {
                ...
                if (Method != "getStatus" && RainBorg.logLevel >= 3) Console.WriteLine(Request);
                ...
                if (Method != "getStatus" && RainBorg.logLevel >= 3) Console.WriteLine(Result.ToString());
